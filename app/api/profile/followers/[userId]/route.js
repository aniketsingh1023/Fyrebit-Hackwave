// api/profile/[userId]/followers/route.js
...
export async function GET(req, { params }) {
  try {
    ...
    console.log("Followers API - Session:", session);
    ...
    console.log("Followers API - Fetching followers for user:", userId);
    ...
    const followersWithStatus = user.followers.map((follower) => ({
      ...follower.toObject(),
      isFollowing:
        currentUser?.following?.includes(follower._id.toString()) || false,
    ...
    console.log("Followers API - Found followers:", followersWithStatus.length);
