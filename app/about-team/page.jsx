...
//   {
//     name: "Aniket Singh",
//     bio: "All-rounder in tech & the fearless team lead 🚀",
...
//                     <a href={member.socials.linkedin}><LinkedinIcon /></a>
//                     <a href={member.socials.instagram}><InstagramIcon /></a>
//                   </div>
//                 </CardContent>
//               </Card>
//             </motion.div>
...
export default function TeamAboutPage() {
  return (
    <div className="min-h-screen bg-black py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-[#F5E6D3] mb-12">Meet the Team</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member, idx) => (
            <motion.div
              key={idx}
              ...
              >
                ...
                <CardContent className="p-6 flex flex-col justify-between flex-1 text-center">
                  ...
                  <div className="flex justify-center space-x-4 mt-4 text-gray-700">
                    <a href={member.socials.github} className="transition-colors hover:text-yellow-600"><GithubIcon /></a>
                    <a href={member.socials.linkedin} className="transition-colors hover:text-yellow-600"><LinkedinIcon /></a>
                    <a href={member.socials.instagram} className="transition-colors hover:text-yellow-600"><InstagramIcon /></a>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
